...
# Remove OAuth configuration for the first step of integration
# c.JupyterHub.authenticator_class = 'oauthenticator.GoogleOAuthenticator'
c.JupyterHub.authenticator_class = 'dummyauthenticator.DummyAuthenticator'
c.DummyAuthenticator.password = "jhub123"
...
c.Kubernetespawner.kube_namespace = os.environ['KSPAWN_NAMESPACE']
